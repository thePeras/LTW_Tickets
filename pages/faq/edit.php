...
<input type="hidden" name="id" value="<?php echo $faq->id?>">
    ...
    <input type="text" name="title" required placeholder="What is the question?" value="<?php echo $faq->title?>">

    <label for="content">
        <p>Answer:</p>
    </label>
    <textarea class="content-area" name="content" rows="10" required placeholder="Write the corresponding answers"><?php echo $faq->content?></textarea>
